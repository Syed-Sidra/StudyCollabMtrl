    ...
    <body>
        <div class="container-fluid" style="min-height: 600px" >
            ...
            <div class="row">
                ...
                <div class="col-sm-4 my-5 rounded-2 p-4 box1" style="min-height: 500px">
                    <form action="UploadServlet" method="post" enctype="multipart/form-data">
                        <label class="fs-5">Uploaded by:</label> <br>
                        <input type="text" placeholder="Your Name"class="mt-2 w-100 box"name="name"> <br>
                        <label class="fs-5 mt-2" >Semester</label> <br>
                        <select class="w-100 mt-2 box" name="sem">
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>5</option>
                        ...
                        <label class="fs-5 mt-2    " >Branch : </label> <br>
                        <select class="w-100 mt-2 box rounded-2" name="branch">
                            <option>CSE</option>
                            <option>AI & DS</option>
                            <option>AI & ML</option>
                            <option>Civil</option>
                        ...
                        <label class="fs-5 mt-2" >Title</label> <br>
                        ...
                        <label class="fs-5 mt-2">Subject:</label> <br>
                        <input type="text" placeholder="Subject Name"class="mt-2 w-100 box " name="subject"> <br>
                        <label class="fs-5 mt-2">File:</label> <br>
                        <input type="file"  class="mt-2 w-100 box" name="file"> <br>
